...
import type { CompanyProfileData } from '@/features/recruiter/settings.types.ts';
...
export const AccountSection: React.FC<AccountSectionProps> = ({
  ...
  const handleLocationChange = (location: string) => {
    handleChange('companyLocation', location);
  };
            ...
            <div className="md:col-span-2">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="text-xs text-default hover:underline"
                >
                  {showAddressDropdowns ? 'Use simple input' : 'Use address selector'}
                </button>
              </div>
