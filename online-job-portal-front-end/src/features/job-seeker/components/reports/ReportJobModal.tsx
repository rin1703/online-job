...
import { useSubmitJobReportMutation } from "@/redux/features/reports/reportApi";
import { Label } from "@radix-ui/react-label";

const REPORT_REASONS = [
  { value: "spam", label: "Spam or fraudulent ad" },
  { value: "fraud", label: "Fraudulent or unreal" },
  { value: "inappropriate", label: "Inappropriate content" },
  { value: "irrelevant", label: "Irrelevant post" },
  { value: "copyrighted", label: "Copyright infringement" },
...
export default function ReportJobModal({
  ...
  const [submitJobReport, { isLoading, error }] = useSubmitJobReportMutation();
            ...
            <div>
              ...
              <div className="flex gap-2 mb-3">
                <input
                  ...
                  placeholder="Enter evidence URL (image, video, website...)"
